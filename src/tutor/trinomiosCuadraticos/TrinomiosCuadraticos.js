...
const TC = ({exercise, nextRouter}) => {
  ...
  useEffect(() => { //when step 2 is completed, open new tab of step 3 
    if (step2Valid != null) {
      setIndex([2]);
    }
  }, [step2Valid]);

  useEffect(() => { //when step 3 is completed, open new tab of step 4
    if (step3Valid != null) {
      setIndex([3]);
    }
  }, [step3Valid]);

  useEffect(() => { //when step 4 is completed, open new tab of step 5
    if (step4Valid != null) {
      setIndex([4]);
    }
  }, [step4Valid]);
          ...
          >
            ...
            >
              <Box flex="1" textAlign="left">
                ...
                {select3&&step2Valid != null&&<Wrap>Paso 3:<SelectStep correct={2} steps={steps} setSelect={setSelect3} contentID={exercise.itemId}></SelectStep></Wrap>}
              </Box>
              <AccordionIcon />
            </AccordionButton>
          </Alert>
          ...
          >
            ...
            >
              <Box flex="1" textAlign="left">
                ...
                {select4&&step3Valid != null&&<Wrap>Paso 4:<SelectStep correct={3} steps={steps} setSelect={setSelect4} contentID={exercise.itemId}></SelectStep></Wrap>}
              </Box>
              <AccordionIcon />
            </AccordionButton>
          </Alert>
          ...
          >
            ...
            >
              <Box flex="1" textAlign="left">
                ...
                {select5&&step4Valid != null&&<Wrap>Paso 5:<SelectStep correct={4} steps={steps} setSelect={setSelect5} contentID={exercise.itemId}></SelectStep></Wrap>}
              </Box>
              <AccordionIcon />
            </AccordionButton>
          </Alert>
