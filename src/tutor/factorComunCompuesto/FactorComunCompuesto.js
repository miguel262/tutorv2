...
const FCC = ({exercise}) => {//info usuario, ---
          ...
          >
            ...
            >
              <Box flex="1" textAlign="left">
                ...
                {select2&&step1Valid != null&&<Wrap>Paso 2:<SelectStep correct={1} steps={steps} setSelect={setSelect2} contentID={exercise.itemId}></SelectStep>
                </Wrap>}
              </Box>
              <AccordionIcon />
            </AccordionButton>
          ...
          >
            ...
            >
              <Box flex="1" textAlign="left">
                ...
                {select3&&step2Valid != null&&<Wrap>Paso 2:<SelectStep correct={2} steps={steps} setSelect={setSelect3} contentID={exercise.itemId}></SelectStep>
                </Wrap>}
              </Box>
              <AccordionIcon />
            </AccordionButton>
